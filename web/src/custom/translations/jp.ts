import { jp as mobileTranslationsJp } from '../../mobile/translations';
...
export const jp: LangType = {
    ...
    'page.header.navbar.quick.exchange': 'クイック取引',
    'page.header.navbar.trade': 'トレード',
    'page.header.navbar.wallets': 'ウォレット',
    'page.header.navbar.openOrders': 'オーダー',
    'page.header.navbar.history': '履歴',
    'page.header.navbar.api': 'API ドキュメント',
    ...
    'page.sidebar.group.value': 'ベース',

    'page.body.trade.header.market': 'マーケット',
    'page.body.trade.header.yours': 'あなたの',

    'page.body.trade.header.markets': 'マーケット',
    'page.body.trade.header.markets.content.market': 'マーケット',
    'page.body.trade.header.markets.content.pair': 'ペア',
    'page.body.trade.header.markets.content.price': '価格',
    'page.body.trade.header.markets.content.last_price': 'Last Price',
    'page.body.trade.header.markets.content.change': 'Change',
    'page.body.trade.header.markets.content.search': '検索',
    'page.body.trade.header.markets.content.volume': 'ボリューム',
    ...
    'page.body.trade.header.newOrder.content.orderType.limit': 'リミット',
    'page.body.trade.header.newOrder.content.orderType.market': 'マーケット',
    ...
    'page.body.trade.header.openOrders.content.market': 'マーケット',
    ...
    'page.body.trade.header.openOrders.content.type.market': 'マーケット',
    ...
    'page.body.trade.header.openOrders.content.total': 'ボリューム',
    ...
    /* Charts */
    'page.body.charts.tabs.chart': 'チャート',
    'page.body.charts.tabs.depth': 'Depth',

    /* Markets Table */
    'page.body.marketsTable.filter.all': '全て',
    'page.body.marketsTable.header.pair': 'マーケット',
    ...
    /* Landing */
    'page.body.landing.header.button1': 'プロフィール',
    'page.body.landing.header.button2': 'ログイン',
    'page.body.landing.header.button3': '会員登録',
    ...
    'page.body.landing.marketInfo.title.button': '取引を始める',
    ...
    'page.body.landing.footer.support': 'サポート',
    'page.body.landing.footer.privacy': 'プライバシー',
    ...
    'page.body.wallets.tabs.deposit': 'デポジット',
    ...
    'page.body.wallets.tabs.deposit.ccy.message.address': 'デポジットアドレス',
    'page.body.wallets.tabs.deposit.ccy.message.button': 'コピー',
    'page.body.wallets.tabs.deposit.ccy.message.success': 'アドレスをコピーしました',
    'page.body.wallets.tabs.deposit.ccy.message.pending': 'デポジットアドレスを作成',
    'page.body.wallets.tabs.deposit.ccy.button.generate': '生成',
    'page.body.wallets.tabs.deposit.ccy.button.address': 'アドレス',
    ...
    'page.body.wallets.tabs.withdraw.modal.button.cancel': 'キャンセル',
    'page.body.wallets.tabs.withdraw.modal.button.withdraw': '出金',
    ...
    'page.body.wallets.beneficiaries.title': '出金アドレス',
    'page.body.wallets.beneficiaries.fiat.title': 'Withdrawal details',
    'page.body.wallets.beneficiaries.dropdown.address': 'アドレス',
    'page.body.wallets.beneficiaries.dropdown.select': '選択',
    'page.body.wallets.beneficiaries.dropdown.name': '名前',
    'page.body.wallets.beneficiaries.dropdown.pending': 'Pending',

    'page.body.wallets.beneficiaries.dropdown.fiat.account': 'アカウント',
    ...
    'page.body.wallets.beneficiaries.dropdown.fiat.name': '名前',
    ...
    'page.body.wallets.beneficiaries.tipAddress': 'アドレス',
    'page.body.wallets.beneficiaries.tipName': '名前',
    ...
    'page.body.history.deposit': 'デポジット履歴',
    ...
    'page.body.history.deposit.header.status': 'ステータス',
    ...
    'page.body.history.trade.header.market': 'マーケット',
    'page.body.history.trade.header.price': '価格',
    'page.body.history.trade.header.total': '合計',
    ...
    'page.body.profile.header.account': 'プロフィール',

    'page.body.profile.header.account.username': 'ユーザー名',
    ...
    'page.body.profile.header.account.content.password.old': '前のパスワード',
    ...
    'page.body.profile.header.account.content.password.change': 'パスワード変更',
    ...
    'page.body.profile.header.referralProgram': 'リファラルリンク',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.profile.verification.email.title': 'メールアドレス',
    ...
    'page.body.profile.verification.progress.level': 'レベル',
    ...
    'page.body.kyc.address.address': 'アドレス',
