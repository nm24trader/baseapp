export const jp = {
    'page.mobile.header.signIn': 'ログイン',
    'page.mobile.footer.home': 'ホーム',
    'page.mobile.footer.orders': 'オーダー',
    'page.mobile.footer.trading': 'トレード',
    'page.mobile.footer.wallets': 'ウォレット',
    'page.mobile.footer.profile': 'プロフィール',
    ...
    'page.mobile.orderButtons.buy': '購入 {base_unit}',
    'page.mobile.orderButtons.sell': '売却 {base_unit}',

    'page.mobile.orders.tabs.open': 'Open',
    'page.mobile.orders.tabs.all': '全て',
    'page.mobile.orders.cancelAll': '全てキャンセル',
    ...
    'page.mobile.orders.header.cancel': 'キャンセル',
    'page.mobile.orders.header.trigger': 'Trigger',
    'page.mobile.orders.header.volume': 'Total',

    'page.mobile.currentMarketInfo.search.placeholder': '検索',
